    ...
    return (
        ...
        <div className="page__inner">
            <div className="cookies">
                <h3>Cookie Policy for sduemmen</h3>

                <p>This is the Cookie Policy for sduemmen, accessible from sduemmen.com</p>
                ...
                <li>
                    <p>We also use social media buttons and/or plugins on this site that allow you to connect with your social network in various ways. For these to work the following social media sites including; {'Facebook, Instagram, Github'} , will set cookies through our site which may be used to enhance your profile on their site or contribute to the data they hold for various purposes outlined in their respective privacy policies.</p>
                </li>
